...
const TreatmentCard = ({
  ...
  return (
    <div className={`relative sm:max-h-64 sm:max-w-80`}>
      ...
      <div className="absolute -bottom-9 left-6  flex flex-col items-start justify-center gap-y-1 rounded-lg bg-primary px-8 pb-4 pt-2 text-white lg:-bottom-8 lg:left-10">
