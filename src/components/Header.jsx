...
const Header = () => {
  ...
  return (
    <div>
      <Container>
        <header className=" flex flex-col gap-y-2 bg-white px-7 py-5 lg:flex-row">
          ...
          <div
            className={
              dropDown
                ? "delay-5000 flex flex-col gap-y-3 bg-white transition-transform duration-300 ease-in-out"
                : "delay-5000 h-0 w-0 overflow-hidden transition-transform duration-300 ease-in-out lg:ml-auto lg:flex lg:h-auto lg:w-max lg:gap-x-8 xl:gap-x-16"
            }
          >
            <nav className="text-sm lg:flex lg:items-center">
              <ul className="flex flex-col lg:flex-row lg:items-center">
                ...
                <li className="px-2 py-2  lg:px-1.5">
                  <NavLink
                    to={"/about"}
                    className={({isActive})=>(`p-2 decoration-primary underline-offset-2 hover:text-primary ${isActive ? "text-primary" : ""} `)}
                  >
                    About
                  </NavLink>
                </li>
